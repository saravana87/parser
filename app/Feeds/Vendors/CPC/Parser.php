...
{
    private const MAIN_DOMAIN = 'https://carolinapetcompany.com/shop/';
    ...
    {
        $body = $this->getHtml( 'div.fl-woo-content-right' );
        ...
        $this->filter( 'ul.products li' )->each( function ( ParserCrawler $c ) {
    ...
    {
        return $this->product ?: $this->getText( 'h2.woocommerce-loop-product__title' );
    }

    public function getCostToUs(): float
    {
        return StringHelper::getMoney( $this->getMoney( 'span.woocommerce-Price-amount' ) );
    }

    public function getImages(): array
    {
        return [ self::MAIN_DOMAIN . $this->getAttr( 'li.type-product img', 'src' ) ];
    }
